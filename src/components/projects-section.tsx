...
const projects: Project[] = [
  ...
  {
    title: "Cosmetologist",
    description: "Landing page moderna y responsiva para un estudio de cosmeatria, con secciones dedicadas a los servicios ofrecidos, una galería de imágenes para mostrar los trabajos realizados, y un apartado de contacto que incluye la ubicación del local mediante Google Maps. Además, integré accesos directos a WhatsApp e Instagram para facilitar la comunicación y permitir que las clientas puedan realizar consultas o reservar turnos de forma rápida y sencilla desde cualquier dispositivo.",
    technologies: ["Next.js", "React", "typescript", "Tailwind CSS"],
    image: "/img/cosmeatria.png",
    github: "https://github.com/EnzoDerviche/Cosmetologist",
    demo: "https://cosmetologist-ok.vercel.app/",
  },
  {
    title: "Deen Garage",
    description: "Landing page moderna y responsiva para un taller de detailing, con secciones dedicadas a los servicios ofrecido y un apartado de contacto que incluye la ubicación del local mediante Google Maps. Además, integré accesos directos a WhatsApp e Instagram para facilitar la comunicación y permitir que las clientas puedan realizar consultas o reservar turnos de forma rápida y sencilla desde cualquier dispositivo.",
    technologies: ["Next.js", "React", "typescript", "Tailwind CSS"],
    image: "/img/deen.png",
    github: "https://github.com/EnzoDerviche/v0-detailing-landing-page",
    demo: "https://deengarage.com/",
  },
  {
    title: "Milena's Nails",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Estos son unos solo algunos de los proyectos que realice. Seguiré compartiendo más.
          </p>
        </div>
